...
void CDrawTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
...
void CDrawTool::OnLButtonDblClk(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
...
void CSelectTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
    CPoint local = point;
    pView->ClientToDoc(local);
...
void CSelectTool::OnLButtonUp(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
...
void CRectTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
    CDrawTool::OnLButtonDown(pView, nFlags, point);
...
void CRectTool::OnLButtonUp(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
    if (point == c_down) {
...
void CRectTool::OnMouseMove(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
...
void CKolorTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
    CPoint local{point};
    pView->ClientToDoc(local);
...
void CLockTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
    CPoint local = point;
    pView->ClientToDoc(local);
...
void CSpaceTool::OnLButtonDown(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
...
void CSpaceTool::OnLButtonUp(CDrawView* pView, const UINT nFlags, const CPoint& point)
{
