...
BEGIN_MESSAGE_MAP(CDrawApp, CWinAppEx)
    ...
    ON_UPDATE_COMMAND_UI(ID_FILE_OPEN, OnDisableMenu)
    ...
    ON_UPDATE_COMMAND_UI(IDM_SENDMSG, OnDisableMenuRDBMS)
    ON_COMMAND(ID_FILE_DBOPENRO, OnFileDBOpenRO)
    ON_COMMAND(ID_FILE_NEW_BATH, OnFileNewBath)
    ON_COMMAND(IDM_PASSWD, OnPasswd)
    ON_COMMAND(IDM_ACCESS, OnAccess)
    ON_UPDATE_COMMAND_UI(IDM_ACCESS, OnUpdateAdmin)
    ON_UPDATE_COMMAND_UI(IDM_DAYDIRS, OnUpdateStudio)
    ON_COMMAND(IDM_NEWUSER, OnNewuser)
    ON_COMMAND(IDM_CAPTIONS, OnCaptions)
    ON_UPDATE_COMMAND_UI(IDM_CAPTIONS, OnUpdateCaptions)
    ON_UPDATE_COMMAND_UI(IDV_COMBO_HEAD, OnUpdateToolBarCombo)
    ON_UPDATE_COMMAND_UI(IDV_COMBO_COLOR, OnUpdateToolBarCombo)
    ON_COMMAND(IDM_NEWTITLE, OnNewTitle)
    ON_COMMAND(IDM_DAYDIRS, OnDaydirs)
    ON_COMMAND(ID_HELP, OnHelp)
    ON_COMMAND(IDM_SENDMSG, OnSendmsg)
    ON_COMMAND(ID_FILE_REFRESH, OnFileRefresh)
    ON_UPDATE_COMMAND_UI(ID_FILE_DBOPENRO, OnDisableMenuRDBMS)
    ON_UPDATE_COMMAND_UI(ID_FILE_NEW, OnDisableMenu)
    ON_UPDATE_COMMAND_UI(ID_FILE_NEW_BATH, OnDisableMenu)
    ON_UPDATE_COMMAND_UI(ID_FILE_PRINT_SETUP, OnDisableMenu)
    ON_UPDATE_COMMAND_UI(ID_FILE_REFRESH, OnDisableMenu)
    ON_UPDATE_COMMAND_UI(IDM_PASSWD, OnDisableMenuRDBMS)
    ON_UPDATE_COMMAND_UI(IDM_NEWUSER, OnUpdateAdmin)
    ON_UPDATE_COMMAND_UI(IDM_NEWTITLE, OnUpdateAdmin)
    //}}AFX_MSG_MAP
    // Standard file based document commands
    ON_COMMAND(ID_FILE_NEW, CWinApp::OnFileNew)
    ON_COMMAND(ID_FILE_OPEN, OnFileOpen)
    ON_COMMAND(ID_FILE_DBOPEN, OnDBOpen)
