--@d:\Velvet\PS\Paginy\DLO2019-30\CreateDLO_2019.sql
declare
   vfun_xx number;
   vmak_xx number;
   vtyp_xx number;
   ...
   vnazwa_typu varchar2(64) := 'DLO-30-lat';
   vnazwa_paginy varchar2(32) := '-Reklama';
   vnazwa_produktu varchar2(6) := 'DLO WA';
   vnaglowek varchar2(15) := 'Rekl';
begin
   -- usuniÄ™cie starej definicji
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+1, 4, 0, '1123.7');
   insert into spacer_prn_fun_arg values (vfun_xx+1, 5, 0, 'moveto');
   insert into spacer_prn_fun_arg values (vfun_xx+1, 6, 0, '708.66');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+2, 4, 0, '1123.7');
   insert into spacer_prn_fun_arg values (vfun_xx+2, 5, 0, 'moveto');
   insert into spacer_prn_fun_arg values (vfun_xx+2, 6, 0, '708.66');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+3, 3, 0, '708.66');
   insert into spacer_prn_fun_arg values (vfun_xx+3, 4, 0, '4');
   insert into spacer_prn_fun_arg values (vfun_xx+3, 5, 0, '45.35');
   insert into spacer_prn_fun_arg values (vfun_xx+3, 6, 0, '1075');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+4, 3, 0, '708.66');
   insert into spacer_prn_fun_arg values (vfun_xx+4, 4, 0, '4');
   insert into spacer_prn_fun_arg values (vfun_xx+4, 5, 0, '45.35');
   insert into spacer_prn_fun_arg values (vfun_xx+4, 6, 0, '1075');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+5, 1, 0, '45.35');
   insert into spacer_prn_fun_arg values (vfun_xx+5, 2, 0, '1095.3');
   insert into spacer_prn_fun_arg values (vfun_xx+5, 3, 0, '1');
   insert into spacer_prn_fun_arg values (vfun_xx+5, 4, 0, '21');
   insert into spacer_prn_fun_arg values (vfun_xx+5, 5, 0, '/Balto-Bold');

   insert into spacer_prn_fun_arg values (vfun_xx+6, 0, 2, 'nr_str');
   insert into spacer_prn_fun_arg values (vfun_xx+6, 1, 0, '754');
   insert into spacer_prn_fun_arg values (vfun_xx+6, 2, 0, '1095.3');
   insert into spacer_prn_fun_arg values (vfun_xx+6, 3, 0, '0');
   insert into spacer_prn_fun_arg values (vfun_xx+6, 4, 0, '21');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+7, 1, 0, '754');
   insert into spacer_prn_fun_arg values (vfun_xx+7, 2, 0, '1103');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+8, 1, 0, '45.35');
   insert into spacer_prn_fun_arg values (vfun_xx+8, 2, 0, '1103');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+9, 1, 0, '754');
   insert into spacer_prn_fun_arg values (vfun_xx+9, 2, 0, '1095');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+10, 1, 0, '45.35');
   insert into spacer_prn_fun_arg values (vfun_xx+10, 2, 0, '1095');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+11, 1, 0, '399.7');
   insert into spacer_prn_fun_arg values (vfun_xx+11, 2, 0, '1095.3');
   insert into spacer_prn_fun_arg values (vfun_xx+11, 3, 0, '25.5');
   ...
   insert into spacer_prn_fun_arg values (vfun_xx+12, 1, 0, '399.7');
   insert into spacer_prn_fun_arg values (vfun_xx+12, 2, 0, '1095.3');
   insert into spacer_prn_fun_arg values (vfun_xx+12, 3, 0, '25.5');
   ...
   insert into spacer_prn_fun_arg values(vfun_xx+13, 2, 0, '765');
   insert into spacer_prn_fun_arg values(vfun_xx+13, 3, 0, '43.16');
   ...
   insert into spacer_prn_fun_arg values(vfun_xx+14, 2, 0, '38');
   insert into spacer_prn_fun_arg values(vfun_xx+14, 3, 0, '43.16');
